...
const AirCompressorMonitoring = () => {
  const { id, plantName, lineName } = useParams()
  console.log("AirComp ID:", id)
  ...
  return (
    <MonitoringDashboard
      ...
      receiveEvent="ReceiveAirCompData"
      joinGroupMethod="JoinAirCompGroup"
      leaveGroupMethod="LeaveAirCompGroup"
      getPastDataMethod="GetAirCompPastData"
      groupId={id}
      navigationPath={(chartId) =>
        `/plantPerformanceUtilities/${plantName}/${lineName}/aircompressor/${id}/monitoring/${chartId}`
      }
      plantName={plantName}
      lineName={lineName}
    />
...
export default AirCompressorMonitoring
