...
interface ThdCurrentDetailProps {
  utilityType: UtilityType // Only pass this when rendering
}

const ThdCurrentDetail: React.FC<ThdCurrentDetailProps> = ({ utilityType }) => {
...
export default ThdCurrentDetail
