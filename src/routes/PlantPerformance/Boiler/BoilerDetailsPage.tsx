    ...
    <div className="">
      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-1 relative">
          ...
          <div className="flex relative border-b-2 border-gray-200">
            <button
              ...
              onClick={() =>
                navigate(
                  `/plantPerformanceUtilities/${plantName}/${lineName}/boiler/${id}`,
                )
              }
            >
              Info & KPIs
            ...
            <button
              ...
              onClick={() =>
                navigate(
                  `/plantPerformanceUtilities/${plantName}/${lineName}/boiler/${id}/monitoring`,
                )
              }
            >
              Monitoring
        ...
        <button
          onClick={() =>
            navigate(
              `/plantPerformanceUtilities/${plantName}/${lineName}/boiler`,
            )
          }
