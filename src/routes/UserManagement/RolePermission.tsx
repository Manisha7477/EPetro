...
//                 value={selectedRole}
//                 onChange={(e) => setSelectedRole(e.target.value)}
//                 className="appearance-none border border-base-300 rounded px-3 py-1 text-sm pr-6 cursor-pointer"
//               >
//                 <option value="All">All</option>
//                 {roles.map((role) => (
//                   <option key={role} value={role}>
...
//               {/* <thead>
//                 <tr className="bg-base-200 border-b border-base-300 text-base-content"> */}
//               <thead className="bg-info font-bold text-[#000000] whitespace-normal">
//                 <tr className="border-b border-base-300">
//                   <th className="p-3 text-left">Permission</th>
//                   {filteredRoles.map((role) => (
//                     <th key={role} className="p-3 text-center">
