...
//   const accessTokenExpTime = nookies.get(ctx).accessTokenExpire || " "
...
//   const userAuthDetails = async () => {
//     // console.log("accessToken Expiry Time: ", accessTokenExpTime)

//     try {
//       if (token && userId) {
//         console.log("Token in auth: ", token)
//         const response = await axios.get(
//           `${process.env.NEXT_PUBLIC_API_URL}/User/GetAllUserDetails_Id`,
//           {
//             params: {
//               userId: userId,
//             },
...
//         const userInfo = response.data[0] // API returns an array

//         const userData: IUser = {
//           userid: userInfo.userId,
//           username: userInfo.firstName + " " + userInfo.lastName, // or however you define it
